...
async def on_ready():
    ...
    print('Ready!')
    return await bot.change_presence(activity=discord.Activity(type=1, name='Developing Update', url='https://twitch.tv/BrodyDoesArt'))

@bot.command(pass_context=True)
async def reload(ctx, *, msg):
    """Load a module."""
    if ctx.message.author.id ==639324485115314198:
